...
<div class="row mt">
	<div class="col-md-12">
		<div class="content-panel">
			<center><h2 style="font-style: sans-serif;"><b>Data Barang</b></h2></center>

      <a href='home.php?page=insert_barang' class="btn btn-primary btn-sm w-20 mt-2 mb-3" style='font-size:14px; margin-top: 1px'><i class="fa fa-plus" aria-hidden="true"></i> Tambah Barang</a>
